...
void launch_game(){
    const char weapons[5][15] = {STICK, SWORD, DAGGER, SPELLBOOK, {}}; //Symboles des armes
    const char treasures[5][10] = {CHEST, PORTAL, TOTEM, TOTEM,
                                   CHEST}; //Symboles des objets spéciaux (coffres, totems, portails)
